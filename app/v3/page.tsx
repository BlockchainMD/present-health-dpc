...
import { Check, CheckCircle, MessageCircle, Clock, Shield, Heart, Phone, ArrowRight, X, ShieldCheck, CheckCircle2 } from "lucide-react";
...
// ============================================================================
// HERO V3 - Portrait + Strong Copy (Minimal, Trust-First)
// ============================================================================
function HeroV3() {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="text-center lg:text-left order-2 lg:order-1">
                        ...
                        <p className="text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">
                            Direct access to your physician. Text, video, or phone—whenever you need it. Same- or next-day appointments. One flat monthly fee.
                        </p>
...
// ============================================================================
// FOUNDER QUOTE SECTION (New for V3)
// ============================================================================
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <p className="text-lg text-muted-foreground">
                        Stop waiting weeks for a 7-minute visit.
                    </p>
                </div>
                ...
                <div className="max-w-4xl mx-auto overflow-hidden rounded-xl border border-border shadow-sm">
                    <div className="grid grid-cols-3 bg-muted/50 p-4 font-semibold text-sm md:text-base">
                        ...
                        <div className="text-center text-muted-foreground">Traditional Care</div>
                        <div className="text-center text-primary font-bold">Present Health</div>
                    </div>

                    <div className="divide-y divide-border">
                        {[
                            { feature: "Wait Time", old: "20+ days", new: "Same or Next Day" },
                            { feature: "Visit Length", old: "7-10 min", new: "30-60 min" },
                            { feature: "Communication", old: "Portal (3-day delay)", new: "Text, Video, Phone" },
                            { feature: "Cost", old: "Copays + Surprises", new: "Flat Monthly Fee" },
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start max-w-5xl mx-auto">
                    <Card className="border-emerald-200 bg-white/80 shadow-sm">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <p className="text-sm text-emerald-900/80">Pay with your HSA card.</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="bg-emerald-100/50 p-6 rounded-xl border border-emerald-200">
                        ...
                        <p className="text-sm text-emerald-800/80 leading-relaxed">
                            Membership covers primary care. Labs and prescriptions are billed separately at transparent prices.
                        </p>
                    </div>
                </div>
...
function FAQAccordionV2() {
    const faqs = [
        { question: "Do I still need insurance?", answer: "Yes—for emergencies and specialists. DPC is for primary care." },
        { question: "Can I use my HSA?", answer: "Starting 2026, HSA funds may cover DPC fees. Consult a tax professional." },
        { question: "Why limit enrollment?", answer: "To protect your access. Fewer patients = more time for you." },
        { question: "What states?", answer: "Select states, expanding soon. Check during signup." }
    ];
