...
export const metadata: Metadata = {
    title: "Diabetes & A1C Management | Present Health",
    description:
        "Comprehensive diabetes and prediabetes care including A1C monitoring, medication management, and lifestyle support through video visits.",
};

export default function DiabetesPage() {
    const whatWeDo = [
        "A1C testing and result interpretation",
        "Blood glucose monitoring and tracking",
        "Medication management (metformin, GLP-1, insulin, etc.)",
    ...
    const howItWorks = [
        ...
        "Ongoing support and follow-up messaging",
    ];
        ...
        <div className="min-h-screen bg-background py-24">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                ...
                <header className="mb-16 text-center max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Diabetes & A1C Management</h1>
                    <p className="text-lg text-muted-foreground">
                        Comprehensive diabetes and prediabetes care including A1C monitoring, medication management, and lifestyle support through convenient video visits.
                    </p>
                </header>
                ...
                <section className="mb-16 bg-slate-50 rounded-lg p-8">
                    <h2 className="text-2xl font-bold mb-4">Why Virtual Works for Diabetes Management</h2>
                    <p className="text-muted-foreground mb-4">
                        Diabetes management is perfect for virtual care. Regular A1C tests, glucose monitoring, and medication adjustments can all be managed through video visits. You have the convenience of checking in from home while maintaining consistent care with your physician.
                    </p>
                </section>
