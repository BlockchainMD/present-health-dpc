...
export const metadata: Metadata = {
    title: "Weight Management | Present Health",
    description:
        "Evidence-based weight management including GLP-1 support, nutrition counseling, and behavior change coaching through video visits.",
};

export default function WeightManagementPage() {
    const whatWeDo = [
        "Weight loss medication options (GLP-1, phentermine, etc.)",
        "Nutrition and dietary counseling",
        "Behavior change support and accountability",
        "Metabolic assessment and monitoring",
        ...
        <div className="min-h-screen bg-background py-24">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                <header className="mb-16 text-center max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Weight Management</h1>
                    <p className="text-lg text-muted-foreground">
                        Evidence-based weight management including GLP-1 support, nutrition counseling, and ongoing coaching through convenient video visits.
                    </p>
                </header>
                ...
                <section className="mb-16 bg-slate-50 rounded-lg p-8">
                    <h2 className="text-2xl font-bold mb-4">Why Virtual Works for Weight Management</h2>
                    <p className="text-muted-foreground mb-4">
                        Weight management benefits from regular check-ins and coaching, which are perfect for virtual care. Monthly video visits allow you to discuss progress, adjust medications, and get support without the hassle of office visits.
                    </p>
                </section>
