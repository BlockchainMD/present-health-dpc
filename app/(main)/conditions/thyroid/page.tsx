...
export const metadata: Metadata = {
    title: "Thyroid Management | Present Health",
    description:
        "Thyroid condition monitoring and medication optimization including TSH testing and dose adjustments through video visits.",
};

export default function ThyroidPage() {
    const whatWeDo = [
        "TSH and thyroid panel testing",
        "Medication management and optimization",
        "Dose adjustments based on lab results",
        "Symptom management and monitoring",
        "Follow-up care and lab tracking",
    ];
    ...
    const howItWorks = [
        ...
        "Schedule follow-up testing and visits",
    ];
        ...
        <div className="min-h-screen bg-background py-24">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                <header className="mb-16 text-center max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Thyroid Management</h1>
                    <p className="text-lg text-muted-foreground">
                        Thyroid condition monitoring and medication optimization including TSH testing and dose adjustments through convenient video visits.
                    </p>
                </header>
                ...
                <section className="mb-16 bg-slate-50 rounded-lg p-8">
                    <h2 className="text-2xl font-bold mb-4">Why Virtual Works for Thyroid Management</h2>
                    <p className="text-muted-foreground mb-4">
                        Thyroid management is straightforward for virtual care. Medication adjustments are based on lab results, which can be reviewed during video visits. Regular monitoring ensures your dose is optimized without requiring in-person appointments.
                    </p>
                </section>
